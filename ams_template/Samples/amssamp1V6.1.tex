...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% amssamp1v6.1.tex -- Sample AMS draft paper
%
%% amssamp1v6.1.tex is nearly identical to amssamp2v6.1.tex, except
%% that amssamp2v6.1.tex uses the [twocol] option to produce
%% two-column text.
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% PREAMBLE
...
\authors{Mototaka Nakamura\correspondingauthor{Mototaka Nakamura, moto@jamstec.go.jp}\aff{a} and Shozo Yamane\thanks{Shozo Yamane's current affiliation: 
Science and Engineering, Doshisha University, Kyotanabe, Kyoto, Japan.}\aff{a}}
...
\botline
\end{tabular*}
\caption{\setstretch{1.2} Percentage of variance explained by the first four
...
\caption{\setstretch{1.2}Climatology of $Bx (10^{-6} s^{-1}$, color) and $U^{200}$(m s$^-1$,
...
\caption{\setstretch{1.2}As in Fig.~10, but for (a),(b) September EOF1; (c),(d) September EOF2; (e),(f) October EOF1; (g),(h) October EOF2; and
